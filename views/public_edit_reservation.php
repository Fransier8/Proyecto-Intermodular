        ...
        <section class="col p-3 overflow-auto">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modificar solicitud reserva</li>
                </ol>
            </nav>
            <h1>Modificar solicitud de reserva</h1>
            <article class="row g-4">
                <div class="col-12 col-md-12 fs-5">
                    <form action="<?= BASE_URL ?>modificar_solicitud_reserva" method="post" class="row g-4">
                        <div class="col-12 col-md-12 fs-5">
                            <div class="row row-cols-1 g-3">
                                <div class="col">
                                    <label class="form-label fw-bold">Motivo:</label>
                                    <textarea type="text" name="reason" class="form-control" required maxlength="3000"
                                        placeholder="Escribe el motivo"><?= htmlspecialchars($reservation['reason']) ?></textarea>
                                </div>
