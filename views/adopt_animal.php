        ...
        <section class="col p-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Adoptar animal</li>
                </ol>
            </nav>
            <h1>Adoptar animal</h1>
            <article class="row g-4">
                <div class="col-12 col-md-12 fs-5">
                    <form action="<?= BASE_URL ?>adoptar_animal" method="post" class="row g-4"
                        ...
                        <div class="col-12 col-md-12 fs-5">
                            <div class="row row-cols-1 row-cols-md-2 g-3">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="message" class="form-control" placeholder="Escribe el mensaje"
                                        required
                                        maxlength="5000"><?= htmlspecialchars($adoption_application['message']) ?></textarea>
                                </div>
                            ...
                            <div class="d-flex flex-column flex-sm-row gap-2 mt-4">
                                <button type="submit"
                                    class="btn bg-orange-primary border-dark border-1 flex-fill">Solicitar adopción</button>
